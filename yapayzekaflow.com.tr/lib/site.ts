...
export const SITE_URL = "https://yapayzekaflow.com.tr";
export const SITE_NAME = "Yapay Zeka Flow";
...
// Kardeş markalar — footer ve schema sameAs için
export const SISTER_SITES = [
  { url: "https://crmyapayzeka.com.tr", label: "crmyapayzeka.com.tr" },
  { url: "https://otomasyoncrm.com.tr", label: "otomasyoncrm.com.tr" },
] as const;
