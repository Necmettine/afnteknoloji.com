...
const flows = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Talep edilen kalemin ERP'de (Netsis) tanımlı olup olmadığı anında sorgulanır",
      ...
      "Üretilecek ürünlerde alt reçete (BOM) açılır; hangi bileşenin stoktan karşılanacağı, hangisinin tedarik edileceği görünür olur",
      "Yurt içi ve yurt dışı talepler kendi kurallarıyla ayrışır (para birimi, teslim şekli, gereken evrak)",
      "Talep tutara veya kaleme göre belirlenen onay kademelerine düşer; onay ve ret gerekçesiyle kaydedilir",
      "Onaylanan talep için tedarikçiye ürün kodu, adet ve teknik açıklamayla otomatik e-posta gönderilir",
      "Tedarikçi dönüşü, termin ve evraklar talebin üzerinde toplanır; dosyalar sipariş bazlı klasör düzeninde saklanır",
      "Gelen fatura ilgili talep ve siparişle eşleştirilir, tutar/miktar farkı işaretlenir",
    ],
    gain: "Bitmiş ürün siparişleri ile yurt dışından gelen hammadde ve yarı mamul talepleri aynı hatta yürür. Üretici hem kendi ürettiği ürünü hem dışarıdan tedarik ettiği bileşeni aynı formdan talep edebilir; ERP'de karşılığı olmayan kalem sisteme sızmaz. Talebin hangi aşamada olduğu ve kimin onayında beklediği her an görünür.",
    highlight: true,
  },
  {
    icon: FileCheck2,
    id: "stok-uygunluk",
    title: "Ürün kodu eşleştirme ve stok uygunluk kontrolü",
    trigger: "Sipariş veya üretim talebinin kaydedilmesi",
    steps: [
      "Talepteki her kalem için ERP'de ürün kartı aranır (kod ve açıklama birlikte değerlendirilir)",
      "Tedarikçinin veya üreticinin kendi kodları, firmanın ERP stok kodlarıyla eşleştirilir",
      "Kesin eşleşme yoksa yakın adaylar listelenir ve doğru kart insana seçtirilir",
      "Stok yeterliyse rezerve edilir; yetersiz kalan miktar otomatik olarak tedarik talebine dönüşür",
      "Mükerrer ürün kartı açılmasının önüne geçilir, kod standardı korunur",
    ],
    gain: "Aynı ürünün farklı kodlarla iki kez açılması ve 'stokta var sanılıp' üretimin durması gibi klasik hatalar akış seviyesinde engellenir. Serbest metinli ürün açıklamasını doğru karta bağlamak yapay zekanın en verimli çalıştığı noktalardan biridir; nihai seçim yine kullanıcıda kalır.",
  },
  {
    icon: FileInput,
    id: "gelen-belge",
