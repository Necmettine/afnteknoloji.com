...
const CONSENT_KEY = "crmyapayzeka-cookie-consent";
const CONSENT_EVENT = "crmyapayzeka-cookie-consent-changed";
...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-[1200] mx-auto max-w-3xl rounded-2xl border border-white/10 bg-ai-deep/95 p-5 shadow-2xl backdrop-blur">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="rounded-xl bg-ai-violet px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-ai-indigo"
          >
            Kabul et
          </button>
        </div>
