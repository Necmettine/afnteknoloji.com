  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-4xl font-extrabold text-black mb-4">For your tailored proposal</h2>
        <p className="text-black/70 text-lg mb-10 max-w-xl mx-auto">
          Get a custom price proposal for your enterprise IT needs. Our expert team will contact you as soon as possible.
        </p>
