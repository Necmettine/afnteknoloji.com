...
export default function Footer() {
  return (
    <footer className="border-t border-it-border/60 bg-it-deep">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-3">
        {/* NAP */}
        <div>
          <h2 className="text-sm font-bold uppercase tracking-wider text-it-sky">
            IT Destek İstanbul
          </h2>
          ...
          <ul className="mt-4 space-y-3 text-sm text-gray-300">
            <li className="flex items-start gap-2">
              <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-it-sky" aria-hidden="true" />
              <span>
                {NAP.street}, {NAP.district}/{NAP.city} {NAP.postalCode}
              </span>
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 shrink-0 text-it-sky" aria-hidden="true" />
              <a href={NAP.phoneHref} className="hover:text-white">
                {NAP.phoneDisplay}
              </a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 shrink-0 text-it-sky" aria-hidden="true" />
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-gray-300">
            ...
            <li>
              <Link href="/bakim-anlasmasi/" className="hover:text-white">
                Bakım Anlaşması
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-gray-300">
            ...
            <li>
              <a
                href="https://turkiyebilisim.com.tr"
                target="_blank"
                rel="noopener"
                className="hover:text-white"
              >
                turkiyebilisim.com.tr
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-it-border/40 py-5 text-center text-xs text-gray-500">
