...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/is-ortaklarimiz",
  }, title: "İş Ortaklarımız | Türkiye Bilişim" };
    ...
    <main>
      ...
      <section className="pt-32 pb-10 bg-[#0A0E1A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Stratejik Ortaklıklar</span>
