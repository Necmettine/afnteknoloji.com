...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/hizmetlerimiz/sosyal-medya-yonetimi",
  },
  title: "Sosyal Medya Yonetimi | Türkiye Bilişim",
...
export default function SosyalMedyaYonetimiPage() {
  return (
    <ServiceLanding
      ...
      description="Sosyal medya sadece paylasim yapmak degil; markanin gorunusunu, dilini ve guven algisini dogru yonetmektir. Türkiye Bilişim olarak icerik plani, tasarim duzeni, paylasim ritmi ve reklam takibi ile markaniza daha duzenli bir dijital durus kazandiriyoruz."
