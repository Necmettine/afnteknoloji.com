...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/hizmetlerimiz/web-tasarim",
  },
  title: "Web Tasarim ve Kurumsal Web Sitesi | Türkiye Bilişim",
...
export default function WebTasarimPage() {
  return (
    <ServiceLanding
      ...
      description="Bir web sitesi sadece gorunen bir sayfa degil, markanizin dijital vitrini ve ilk guven noktasi olmalidir. Türkiye Bilişim olarak hem estetik hem de kurumsal olarak guven veren, hizli acilan ve mobilde sorunsuz calisan web siteleri tasarliyoruz."
