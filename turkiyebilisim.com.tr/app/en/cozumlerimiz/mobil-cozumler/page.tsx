...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/en/cozumlerimiz/mobil-cozumler",
  }, title: "Mobile Solutions | Türkiye Bilişim" };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/en/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/25">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Solution Portfolio</span>
