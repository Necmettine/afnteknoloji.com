...
export const metadata = {
  title: "Fortinet Solutions | Türkiye Bilişim",
  description: "Türkiye Bilişim is an authorized Fortinet solution partner offering FortiGate, FortiAnalyzer, FortiSwitch and FortiClient sales, installation and maintenance services.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/fortinet" },
};
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#EE3124]/10 via-transparent to-[#06B6D4]/5" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                As an authorized Fortinet solution partner, Türkiye Bilişim provides sales, installation and maintenance services for FortiGate, FortiAnalyzer, FortiSwitch and FortiClient products.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href="/en/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Product Portfolio</span>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="/en/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
