...
export const metadata = {
  title: "Huawei Solutions | Türkiye Bilişim",
  description: "Türkiye Bilişim is a Huawei Elite Partner offering end-to-end smart infrastructure solutions including object storage, VM backup, on-premise migration and clustering.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/huawei" },
};
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Our Services</span>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="/en/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/25">
              Get a Quote <ArrowRight className="w-5 h-5" />
            </a>
