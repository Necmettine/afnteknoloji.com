...
export const metadata = {
  title: "Veeam Data Protection | Türkiye Bilişim",
  description: "Türkiye Bilişim is a Veeam Silver Partner offering enterprise data backup, replication and disaster recovery solutions.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/veeam" },
};
    ...
    <main className="bg-[#0A0E1A] min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            As Türkiye Bilişim, a Veeam Silver Partner, we provide enterprise data backup, replication and disaster recovery solutions.
          </p>
          ...
          <div className="bg-gradient-to-r from-[#007DB8]/10 to-[#007DB8]/5 border border-[#007DB8]/20 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Türkiye Bilişim is part of Veeam's official Silver Partner program. This status certifies top-level performance in technical competency, sales expertise and customer satisfaction. With our certified Veeam engineers, we design and implement the most suitable data protection strategy for your organization.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-12">We offer license sales, installation, configuration and technical support services as Türkiye Bilişim.</p>
