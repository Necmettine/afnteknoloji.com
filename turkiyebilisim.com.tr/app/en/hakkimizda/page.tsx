...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/en/hakkimizda",
  }, title: "About Us | Türkiye Bilişim" };
      ...
      <section className="pt-32 pb-20 bg-[#0A0E1A] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Who we are</span>
            <h1 className="text-4xl font-extrabold mt-3 mb-4">About Us</h1>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
              Türkiye Bilişim has been operating since 2008 in enterprise IT infrastructure, system security, and technology
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={s.label} className="gradient-border rounded-2xl p-6 text-center">
                  <div className="text-3xl font-black text-[#06B6D4]">{s.val}</div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="glass rounded-2xl p-6 hover:border-[#06B6D4]/30 transition-all hover:-translate-y-1">
                <div className="w-12 h-12 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                  <v.icon className="w-6 h-6 text-[#06B6D4]" />
                </div>
          ...
          <div className="mt-24">
            <div className="text-center mb-12">
              <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Authorized Partnerships</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={cert.brand} className="bg-white/3 border border-white/8 rounded-2xl p-6 hover:border-white/20 transition-all group">
                  ...
                  <h3 className="text-white font-bold text-lg mb-1 group-hover:text-[#06B6D4] transition-colors">{cert.brand}</h3>
          ...
          <div className="mt-24 text-center">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Official Certificate</span>
            ...
            <div className="inline-block overflow-hidden max-w-md">
              <Image
                src="/iso-27001.jpg"
                alt="Türkiye Bilişim ISO 27001 Authorization Certificate"
                width={800}
                height={1100}
