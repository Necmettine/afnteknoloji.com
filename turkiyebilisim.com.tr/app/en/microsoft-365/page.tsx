...
export const metadata = {
  ...
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/microsoft-365" },
};
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              As a Microsoft Silver Partner, Türkiye Bilişim provides the right Microsoft 365 license for your business and delivers
              deployment, configuration, and technical support services.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/en/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/30">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Products & Services</span>
      ...
      <section className="py-24 bg-[#080C18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Licensing Plans</span>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">How We Work</span>
      ...
      <section className="py-20 bg-[#080C18]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="/en/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/30">
