...
export const metadata = {
  title: "Zimbra Turkey | Türkiye Bilişim",
  description: "Türkiye Bilişim is the authorized Zimbra distributor in Turkey, offering enterprise email, calendar and collaboration solutions.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/zimbra" },
};
...
const features = [
  ...
  { icon: Globe, title: "Zimbra Turkey Distributor", desc: "Türkiye Bilişim is the authorized distributor of Zimbra in Turkey." },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Zimbra Turkey</span>
            </div>
            <h1 className="text-4xl font-extrabold mt-3 mb-4">Zimbra Enterprise Email Solutions</h1>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              As Türkiye Bilişim, we are the authorized distributor of Zimbra in Turkey. We offer enterprise email, calendar and collaboration solutions.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {features.map((f) => (
              <div key={f.title} className="gradient-border rounded-2xl p-6 hover:border-[#06B6D4]/40 transition-all hover:-translate-y-1">
          ...
          <div className="gradient-border rounded-2xl p-10 text-center">
            ...
            <a href="/en/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-lg hover:shadow-cyan-500/30">
