...
export const metadata = {
  title: "Security Software | EDR & XDR Solutions | Türkiye Bilişim",
  description: "Kaspersky and Bitdefender EDR & XDR endpoint security solutions. Sales, installation and support from Türkiye Bilişim.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/guvenlik-yazilimlari" },
};
      ...
      <section className="pt-32 pb-20 bg-[#0A0E1A] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Security Software</span>
            <h1 className="text-4xl lg:text-5xl font-extrabold mt-3 mb-6">
              EDR & XDR Solutions<br />
              <span className="text-[#06B6D4]">Next-Generation Security</span>
            </h1>
          ...
          {brands.map((brand) => (
            <div key={brand.name} className="mb-20">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="px-3 py-1 bg-[#06B6D4]/10 border border-[#06B6D4]/30 text-[#06B6D4] text-xs font-bold rounded-full">
                  {brand.badge}
                </span>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {brand.products.map((product) => (
                  <div key={product.name} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-[#06B6D4]/30 transition-colors">
                    <div className="w-12 h-12 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                      <product.icon className="w-6 h-6 text-[#06B6D4]" />
                    </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-10 mb-16">
            <h2 className="text-2xl font-extrabold text-white text-center mb-2">Why Türkiye Bilişim?</h2>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/en/iletisim"
                className="px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
                Request a Quote
              </a>
              <a href="tel:+902165725040"
                className="px-8 py-4 bg-white/5 border border-white/10 text-white font-semibold rounded-xl hover:border-[#06B6D4]/30 transition-all">
                +90 216 572 50 40
              </a>
            </div>
          </div>
