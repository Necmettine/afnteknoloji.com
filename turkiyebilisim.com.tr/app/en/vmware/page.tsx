...
export const metadata = {
  title: "VMware Solutions | Türkiye Bilişim",
  description: "Türkiye Bilişim is a VMware Enterprise Solution Partner providing sales, installation, configuration and technical support services for vSphere, vSAN, Horizon VDI and NSX.",
  alternates: { canonical: "https://turkiyebilisim.com.tr/en/vmware" },
};
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#607078]/20 via-transparent to-[#06B6D4]/5" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                As a VMware Enterprise Solution Partner, Türkiye Bilişim provides sales, installation, configuration and technical support services for vSphere, vSAN, Horizon VDI and NSX products.
              </p>
