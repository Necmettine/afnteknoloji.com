...
export const metadata = {
  title: "Güvenlik Yazılımları | EDR & XDR Çözümleri | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/guvenlik-yazilimlari" },
};
    ...
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#06B6D4]/10 border border-[#06B6D4]/20 text-[#06B6D4] text-sm font-semibold mb-6">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/25">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6 text-center">
            <div className="gradient-border rounded-2xl p-6">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">AV</div>
            ...
            <div className="gradient-border rounded-2xl p-6 border-[#06B6D4]/30">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">EDR</div>
            ...
            <div className="gradient-border rounded-2xl p-6">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">XDR</div>
      ...
      <section className="py-24 bg-[#080C18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Neden Türkiye Bilişim</span>
            ...
            {whyUs.map((w, i) => (
              <div key={i} className="gradient-border rounded-2xl p-6 hover:-translate-y-1 transition-all">
                <div className="w-11 h-11 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                  <w.icon className="w-6 h-6 text-[#06B6D4]" />
                </div>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/25">
