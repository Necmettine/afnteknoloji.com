...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/zimbra",
  }, title: "Zimbra Türkiye | Türkiye Bilişim" };
...
const features = [
  ...
  { icon: Globe, title: "Zimbra Türkiye Distribütörü", desc: "Türkiye Bilişim olarak Zimbra'nın Türkiye yetkili distribütörüyüz." },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Zimbra Türkiye</span>
            </div>
            <h1 className="text-4xl font-extrabold mt-3 mb-4">Zimbra Kurumsal E-posta Çözümleri</h1>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Türkiye Bilişim olarak Zimbra'nın Türkiye yetkili distribütörüyüz. Kurumsal e-posta, takvim ve işbirliği çözümleri sunuyoruz.
            </p>
          </div>
          ...
          <div className="gradient-border rounded-2xl p-10 text-center">
            ...
            <a href="/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-lg hover:shadow-cyan-500/30">
