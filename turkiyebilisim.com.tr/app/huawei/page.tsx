...
export const metadata = {
  title: "Huawei Çözümleri | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/huawei" },
};
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Hizmetlerimiz</span>
