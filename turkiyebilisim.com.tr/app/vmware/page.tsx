...
export const metadata = {
  title: "VMware Sanallaştırma | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/vmware" },
};
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Türkiye Bilişim, VMware Enterprise Solution Partner olarak vSphere, vSAN, Horizon VDI ve NSX ürünlerinde satış, kurulum, yapılandırma ve teknik destek hizmetleri sunmaktadır.
              </p>
              <div className="flex flex-wrap gap-4">
                <a href="/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Ürün Portföyü</span>
