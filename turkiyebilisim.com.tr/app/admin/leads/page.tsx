...
export default async function LeadsPage({ searchParams }: PageProps) {
  ...
  const adminKey = process.env.ADMIN_KEY ?? "tb2024";
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h1 style={{ color: "#06B6D4", fontSize: 22, fontWeight: 700, margin: "0 0 10px" }}>
            Yetkisiz Erişim
          </h1>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          />
          <span style={{ color: "#06B6D4", fontWeight: 800, fontSize: 18, letterSpacing: "-0.3px" }}>
            TB Admin
          </span>
