...
export default async function OfferResponsePage({
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(6,182,212,0.12),_transparent_38%),linear-gradient(180deg,#f8fbff_0%,#eef4ff_100%)] text-slate-900">
      <Header />
          ...
          >
            ...
            <div className="px-8 py-8 sm:px-10">
              ...
              <p className="mt-6 text-sm leading-7 text-slate-500">
                Sorulariniz icin{" "}
                <a className="font-semibold text-slate-900 underline decoration-slate-300 underline-offset-4" href="mailto:satis@turkiyebilisim.com.tr">
                  satis@turkiyebilisim.com.tr
                </a>{" "}
