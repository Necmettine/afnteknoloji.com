...
export const metadata = {
  title: "Microsoft 365 | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/microsoft-365" },
};
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0078D4]/10 via-transparent to-[#06B6D4]/5" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              Türkiye Bilişim olarak Microsoft Silver Partner sıfatıyla işletmeniz için en uygun Microsoft 365 lisansını temin ediyor, kurulum, yapılandırma ve teknik destek hizmetleri sunuyoruz.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/iletisim" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/30">
      ...
      {/* Neden Türkiye Bilişim ile Microsoft 365 */}
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Ürünler ve Hizmetler</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((p) => (
              <div key={p.name} className="gradient-border rounded-2xl p-8 hover:border-[#06B6D4]/30 transition-all group hover:-translate-y-1">
      ...
      <section className="py-24 bg-[#080C18]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Lisans Planları</span>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {plans.map((plan) => (
              <div key={plan.name}
                className={`gradient-border rounded-2xl p-8 relative transition-all hover:-translate-y-1 ${plan.recommended ? "border-[#06B6D4]/40" : ""}`}>
                {plan.recommended && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-[#06B6D4] text-black text-xs font-bold rounded-full whitespace-nowrap">
                    EN POPÜLER
                  </div>
                )}
                <div className="mb-2">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Nasıl Çalışıyoruz</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.step} className="gradient-border rounded-2xl p-6 text-center">
                <div className="text-4xl font-black text-[#06B6D4]/30 mb-3">{s.step}</div>
      ...
      <section className="py-20 bg-[#080C18]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/30">
