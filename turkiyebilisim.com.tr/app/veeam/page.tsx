...
export const metadata = {
  title: "Veeam Veri Yedekleme | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/veeam" },
};
    ...
    <main className="bg-[#0A0E1A] min-h-screen">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Türkiye Bilişim olarak Veeam Silver Partner sıfatıyla kurumsal veri yedekleme, replikasyon ve felaket kurtarma çözümleri sunuyoruz.
          </p>
          ...
          <div className="bg-gradient-to-r from-[#007DB8]/10 to-[#007DB8]/5 border border-[#007DB8]/20 rounded-2xl p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Türkiye Bilişim, Veeam'in resmi Silver Partner programına dahildir. Bu statü; teknik yetkinlik, satış uzmanlığı ve müşteri memnuniyeti kriterlerinde üst düzey performansı belgeler. Sertifikalı Veeam mühendislerimiz ile kurumunuza en uygun veri koruma stratejisini tasarlıyor ve hayata geçiriyoruz.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-12">Türkiye Bilişim olarak lisans satışı, kurulum, yapılandırma ve teknik destek hizmetleri sunuyoruz.</p>
