...
export const metadata = {
  title: "Fortinet Çözümleri | Türkiye Bilişim",
  alternates: { canonical: "https://turkiyebilisim.com.tr/fortinet" },
};
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Türkiye Bilişim, Fortinet'in yetkili çözüm ortağı olarak FortiGate, FortiAnalyzer, FortiSwitch ve FortiClient ürünlerinin satış, kurulum ve bakım hizmetlerini sunmaktadır.
              </p>
