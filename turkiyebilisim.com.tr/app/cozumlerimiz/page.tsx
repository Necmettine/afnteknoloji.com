...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/cozumlerimiz",
    languages: {
      "tr": "https://turkiyebilisim.com.tr/cozumlerimiz",
      "en": "https://turkiyebilisim.com.tr/en/cozumlerimiz",
    },
  }, title: "Çözümlerimiz | Türkiye Bilişim" };
      ...
      <section className="pt-32 pb-20 bg-[#0A0E1A] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Teknoloji Çözümleri</span>
