...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/cozumlerimiz/veri-tekillestirme",
    languages: {
      "tr": "https://turkiyebilisim.com.tr/cozumlerimiz/veri-tekillestirme",
      "en": "https://turkiyebilisim.com.tr/en/cozumlerimiz/veri-tekillestirme",
    },
  }, title: "Veri Tekilleştirme | Türkiye Bilişim" };
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#06B6D4]/8 via-transparent to-blue-500/5" />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            {[
              ...
              <div key={i} className="gradient-border rounded-2xl p-6">
                <div className="text-3xl font-black text-[#06B6D4] mb-1">{s.val}</div>
