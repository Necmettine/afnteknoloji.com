...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/cozumlerimiz/mobil-cozumler",
    languages: {
      "tr": "https://turkiyebilisim.com.tr/cozumlerimiz/mobil-cozumler",
      "en": "https://turkiyebilisim.com.tr/en/cozumlerimiz/mobil-cozumler",
    },
  }, title: "Mobil Çözümler | Türkiye Bilişim" };
  ...
  return (
    <main className="bg-[#0A0E1A] text-white min-h-screen">
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0078D4]/8 via-transparent to-[#06B6D4]/5" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6 text-center">
            <div className="gradient-border rounded-2xl p-6">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">BYOD</div>
            ...
            <div className="gradient-border rounded-2xl p-6 border-[#06B6D4]/30">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">COPE</div>
            ...
            <div className="gradient-border rounded-2xl p-6">
              <div className="text-2xl font-black text-[#06B6D4] mb-2">COBO</div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Çözüm Portföyü</span>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
