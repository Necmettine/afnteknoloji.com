...
export const metadata = {
  alternates: {
    canonical: "https://turkiyebilisim.com.tr/referanslarimiz",
    languages: {
      "tr": "https://turkiyebilisim.com.tr/referanslarimiz",
      "en": "https://turkiyebilisim.com.tr/en/referanslarimiz",
    },
  }, title: "Referanslarimiz | Türkiye Bilişim" };
      ...
      <section className="pt-32 pb-20 bg-[#0A0E1A] min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Musterilerimiz</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {sectors.map((sector) => (
              <div key={sector.name} className="gradient-border rounded-2xl p-6 text-center hover:border-[#06B6D4]/40 transition-all">
                <div className="text-3xl font-black text-[#06B6D4] mb-2">{sector.count}</div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {processSteps.map((step) => (
              <div key={step.title} className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-[#06B6D4]/10">
          ...
          <div className="glass rounded-2xl p-10 text-center">
            ...
            <a
              href="/iletisim"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all"
            >
              Iletisime gec
            </a>
          </div>
