          ...
          {status === "success" ? (
            <div className="gradient-border rounded-2xl p-12 text-center">
              ...
              <button onClick={() => setStatus("idle")}
                className="px-6 py-3 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all">
                Yeni Talep Olustur
              </button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="gradient-border rounded-2xl p-8 space-y-6">
                  ...
                  {[
                    ...
                    <div key={f.name}>
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#06B6D4]/50 transition-colors text-sm"
                      />
                    </div>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <select name="category" value={form.category} onChange={handleChange} required
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#06B6D4]/50 transition-colors text-sm">
                ...
                <div>
                  ...
                  <textarea name="description" value={form.description} onChange={handleChange} required rows={6}
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#06B6D4]/50 transition-colors text-sm resize-none"
                  />
                </div>
              </div>
              ...
              <button type="submit" disabled={status === "sending"}
                className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all disabled:opacity-50 disabled:cursor-not-allowed">
