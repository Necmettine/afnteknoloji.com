...
export const cozumler: Record<string, { title: string; desc: string; content: string; icon: string }> = {
  ...
  "zimbra-turkiye": {
    ...
    content: "Türkiye Bilişim olarak Zimbra'nın Türkiye yetkili distribütörüyüz. Zimbra Collaboration Suite ile kurumsal e-posta, takvim, kişi yönetimi ve anlık mesajlaşma çözümleri sunuyoruz.",
  },
  "veri-tekillestirme": {
  ...
  "microsoft-365": {
    ...
    content: "Türkiye Bilişim, Microsoft Silver Partner sıfatıyla Teams, OneDrive, SharePoint, Exchange Online ve Azure Active Directory dahil tüm Microsoft 365 ürün ailesinin lisans satışı, kurulum, yapılandırma ve 7/24 teknik destek hizmetlerini sunmaktadır.",
  },
