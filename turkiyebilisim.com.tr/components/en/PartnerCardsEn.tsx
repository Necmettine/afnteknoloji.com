    ...
    <section id="partners" className="py-24 bg-[#080C18]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Authorized Partners</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {partners.map((p) => (
            <a key={p.name} href={p.href}
              className="relative group gradient-border rounded-2xl p-8 hover:border-[#06B6D4]/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/50 overflow-hidden block">
