    ...
    <section className="hero-tech relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20" style={{ zIndex: 10 }}>
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#06B6D4]/10 border border-[#06B6D4]/20 text-[#06B6D4] text-sm font-medium mb-8">
            ...
            <div className="flex gap-8 mb-10">
              <div><div className="text-3xl font-black text-[#06B6D4]">500+</div><div className="text-sm text-gray-400 mt-1">Happy Clients</div></div>
              <div><div className="text-3xl font-black text-[#06B6D4]">10+</div><div className="text-sm text-gray-400 mt-1">Years Experience</div></div>
              <div><div className="text-3xl font-black text-[#06B6D4]">7/24</div><div className="text-sm text-gray-400 mt-1">Technical Support</div></div>
            </div>

            <div className="flex flex-wrap gap-4">
              <a href="#services" className="flex items-center gap-2 px-7 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all hover:shadow-xl hover:shadow-cyan-500/30 hover:-translate-y-0.5 active:scale-95">
