        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-gray-400">
              ...
              approach the organization. At Türkiye Bilişim, we take shared responsibility for planning, implementation, and
          ...
          <div className="grid gap-4">
            {pillars.map((pillar) => (
              <div
                key={pillar.title}
                className="rounded-2xl border border-white/10 bg-white/5 p-6 transition-colors hover:border-[#06B6D4]/30"
              >
