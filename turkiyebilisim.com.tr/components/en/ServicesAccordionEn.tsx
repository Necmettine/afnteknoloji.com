  ...
  return (
    <section id="services" className="py-24 bg-[#0A0E1A]">
      <style>{`
        ...
        details.acc-item[open] summary { color: #06B6D4; background: rgba(6,182,212,0.08); border-bottom: 1px solid rgba(255,255,255,0.06); }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">What we do</span>
