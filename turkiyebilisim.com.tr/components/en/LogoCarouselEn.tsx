  ...
  return (
    <section className="py-20 bg-[#080C18] border-y border-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 text-center">
        <span className="text-[#3B82F6] text-sm font-semibold tracking-widest uppercase">Partner Brands</span>
      ...
      <div className="relative">
        <div className="flex animate-scroll gap-8 w-max">
          {doubled.map((logo, i) => (
            <div
              key={i}
              className="flex-shrink-0 w-36 h-20 glass rounded-xl flex flex-col items-center justify-center gap-2 hover:border-[#3B82F6]/40 transition-all group cursor-default px-3"
            >
