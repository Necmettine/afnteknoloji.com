...
const services = [
  { name: "Teams", icon: "Teams", desc: "Video conferencing and enterprise collaboration" },
  { name: "OneDrive", icon: "OneDrive", desc: "Enterprise cloud storage and file sharing" },
  { name: "SharePoint", icon: "SharePoint", desc: "Team collaboration and content management" },
  { name: "Exchange Mail", icon: "Exchange", desc: "Enterprise email and calendar management" },
  { name: "Azure PC", icon: "AzurePC", desc: "Cloud-based virtual desktop solutions" },
  { name: "Azure AD", icon: "AzureAD", desc: "Identity management and access control" },
  { name: "Azure VM", icon: "AzureVM", desc: "Flexible and scalable virtual machines" },
];

export default function MicrosoftServicesEn() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-[#06B6D4] text-sm font-semibold tracking-widest uppercase">Microsoft Silver Partner</span>
          </div>
          <h2 className="text-4xl font-extrabold mb-4">Microsoft Silver Partner <span className="text-gradient">Services</span></h2>
          <p className="text-gray-400 max-w-2xl mx-auto">Licensing, deployment, and support for Microsoft 365, CSP Exchange, SharePoint, OneDrive, Azure Backup, and more.</p>
        </div>
        ...
        <div className="mt-14 text-center">
          <a href="/en/iletisim" className="inline-flex items-center gap-2 px-8 py-4 bg-[#0078D4] hover:bg-[#006cbd] text-white font-bold rounded-xl transition-all hover:shadow-xl hover:shadow-blue-900/30">
            Get a Microsoft licensing quote
          </a>
        </div>
      </div>
    </section>
