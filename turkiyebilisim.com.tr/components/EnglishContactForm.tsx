    ...
    <div className="glass rounded-2xl p-8">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 py-4 bg-[#06B6D4] text-black font-bold rounded-xl hover:bg-[#0891B2] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
        >
