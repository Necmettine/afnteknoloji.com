...
export default function MicrosoftServices() {
  return (
    <section className="section-shell relative overflow-hidden py-24" style={{ background: "linear-gradient(135deg, #050810 0%, #0D1525 50%, #050810 100%)" }}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mx-auto max-w-2xl text-base leading-7 text-slate-400">
            Microsoft 365, CSP Exchange, SharePoint, OneDrive, Azure Yedekleme ve daha fazlası için
            lisans, kurulum ve destek hizmeti.
          </p>
        </div>
        ...
        <div className="mt-14 text-center">
          <a href="/iletisim" className="inline-flex items-center gap-2 rounded-2xl bg-[#0078D4] px-8 py-4 font-bold text-white transition-all hover:-translate-y-0.5 hover:bg-[#1293f5] hover:shadow-xl hover:shadow-blue-900/30">
...
function ServiceCard({ name, icon, desc }: { name: string; icon: string; desc: string }) {
  ...
  return (
    <div className="panel-surface group cursor-pointer rounded-[26px] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#0078D4]/40">
